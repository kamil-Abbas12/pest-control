...
export async function POST(req: NextRequest) {
  try {
    ...
    // The form sends "ownsHome" (see components/Form.tsx); the solar version
    // of this route read "hasInsurance" for the same reused sheet column.
    ...
    await db.collection(COLLECTION).insertOne({
      ...
      source: "pest-control-landing-page",
      status: "new",
      createdAt: new Date(),
    });
    ...
    payload.append(ENTRY_IDS.request, ownsHome);
